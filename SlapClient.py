...
class SlapClient(object):
    ...
    @classmethod
    def chemical_query(cls, service, chemical_element, output_format = "txt", minimum=None, maximum=None, slap_version=1.0):
        '''
        ...
        data = cls.query(service, chemical_element, slap_version=slap_version, wavelenght=wave, CHEMICAL_ELEMENT=chemical_element)
...
if __name__ == "__main__":
    ...
    data = client.query_service(wavelength=1.0)
    print data
